                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="d-flex justify-content-between col-md-3">
                                <div class="form-check">
                                    <input type="checkbox" class="form-check-input" id="yes" name="yes" checked>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="d-flex justify-content-between col-md-3">
                                ...
                                <div class="form-check">
                                    <input type="checkbox" class="form-check-input" id="not" name="no" checked>
                                    <label class="form-check-label" for="no">&nbsp;No</label>
                                </div>
                            </div>
                        </div>
                        <div class="mb-3">
                            <label for="share-responsibility" class="form-label">Share Responsibility <span class="text-danger">*</span></label>
                            <div class="d-flex justify-content-between col-md-3">
                                <div class="form-check">
                                    <input type="checkbox" class="form-check-input" id="yes" name="yes">
                                    <label class="form-check-label" for="yes">&nbsp;Yes</label>
