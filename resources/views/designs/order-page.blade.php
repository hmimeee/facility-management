                ...
                <div class="card">
                    <div class="card-body">
                        <div class="mb-3">
                            ...
                            <input type="text" id="id-number" class="form-control"  placeholder="Order Id Number">
                        </div>

                        <div class="mb-3">
                            <label for="associated-product" class="form-label">Associated Product <span class="text-danger">*</span></label>
                            <input type="text" id="associated-product" class="form-control" placeholder="Associated Product">
                        </div>
                        <div class="mb-3">
